...
REFER TO THE NOTES AT THE END ON HOW TO SET THE ENVIRONMENT VARIABLES, AFTER FOLLOWING THE INSTRUCTIONS.
...
* `-task` can be {`ext, abs`}. The default is ext. Data has to be set up with SEP and CLS tokens.
